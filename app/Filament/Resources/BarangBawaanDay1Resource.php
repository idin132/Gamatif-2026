    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\ToggleColumn::make('barang_1_day_1')->label('Barang 1'),
                Tables\Columns\ToggleColumn::make('barang_2_day_1')->label('Barang 2'),
                Tables\Columns\ToggleColumn::make('barang_3_day_1')->label('Barang 3'),
                Tables\Columns\ToggleColumn::make('barang_4_day_1')->label('Barang 4'),
                Tables\Columns\ToggleColumn::make('barang_5_day_1')->label('Barang 5'),
            ])
            ->filters([
