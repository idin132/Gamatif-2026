        ...
        @else
            ...
            <div class="mt-5 pt-4 border-t border-gold-500/10">
                ...
                <div class="grid grid-cols-3 gap-3 text-center">
                    <div class="p-3 rounded-sm" style="background: rgba(6,78,59,0.2); border: 1px solid rgba(5,150,105,0.3);">
                    ...
                    <div class="p-3 rounded-sm" style="background: rgba(30,58,138,0.2); border: 1px solid rgba(59,130,246,0.3);">
                    ...
                    <div class="p-3 rounded-sm" style="background: rgba(127,29,29,0.2); border: 1px solid rgba(239,68,68,0.3);">
