...
<head>
    ...
    <!-- Favicon GAMATIF 2026 -->
    <link rel="icon" type="image/png" href="{{ asset('images/gamatif-icon.png') }}">
    <link rel="shortcut icon" type="image/png" href="{{ asset('images/gamatif-icon.png') }}">
...
<body class="text-zinc-100 selection:bg-gold-500 selection:text-black">
    ...
    ══════════════════════════════════════════════════════════════════ -->
    <header id="navbar" class="fixed top-0 inset-x-0 z-50 transition-all duration-500" style="background: transparent;">
        <div class="max-w-screen-xl mx-auto px-6 lg:px-10 h-20 flex items-center justify-between">
                    ...
                    <div x-show="open" x-transition class="absolute right-0 mt-2 w-52 rounded-lg overflow-hidden z-50"
                        ...
                        <div class="border-t border-gold-500/15 py-1">
                            <form method="POST" action="{{ route('peserta.logout') }}">
                                @csrf
                                <button type="submit"
                                    class="w-full text-left px-4 py-2.5 text-sm text-rose-400 hover:text-rose-300 hover:bg-white/5 transition">
                                    Logout
                                </button>
                            </form>
                        </div>
            ...
            @else
                ...
                <div class="hidden md:flex items-center gap-3">
                    <a href="{{ route('peserta.login') }}" class="btn-glass-outline px-5 py-2.5 rounded-sm">
                        Masuk
                    </a>
                    <a href="{{ route('peserta.register') }}" class="btn-glass px-5 py-2.5 rounded-sm">
                        Registrasi
                    </a>
                </div>
            @endauth
    ...
    <section id="beranda" class="hero-bg relative min-h-screen overflow-hidden">
        ...
        <div class="relative z-10 max-w-screen-xl mx-auto px-6 lg:px-10
            ...
            <div class="flex justify-center md:justify-end">
                <img src="{{ asset('images/maskot.png') }}" alt="Maskot GAMATIF 2026"
        ...
        <!-- bottom fade to body -->
        <div
            class="absolute bottom-0 inset-x-0 h-24 bg-gradient-to-t from-[#0a0806] to-transparent z-20 pointer-events-none">
        </div>
    </section>
    ...
    <section id="about" class="py-20 sm:py-28 px-6 lg:px-10">
        <div class="max-w-screen-xl mx-auto">
            ...
            <div class="max-w-4xl mx-auto text-center mb-8 md:mb-14 reveal">
                <h2
                    class="font-cinzel text-2xl md:text-3xl lg:text-4xl font-extrabold tracking-tight text-white mb-3 md:mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 text-left">
                ...
                <div class="card-glass p-4 md:p-6 rounded-lg reveal group transition-transform hover:scale-105"
                    ...
                    <h3 class="font-cinzel text-base md:text-xl font-bold text-white mb-1.5 md:mb-2">Pengembangan Diri
                    </h3>
                    <p class="text-sm md:text-base text-zinc-400 leading-relaxed">
                ...
                @forelse($jadwals as $i => $jadwal)
                    <div class="card-glass rounded-lg p-7 transition-all duration-300 reveal group"
                        ...
                        <div class="flex items-center justify-between mb-5">
                            ...
                            <span
                                class="w-2 h-2 rounded-full bg-gold-500 opacity-60 group-hover:opacity-100 transition"></span>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    @foreach($calonKetua as $i => $calon)
                        <div class="card-glass rounded-lg p-8 flex flex-col items-center text-center
                                                transition-all duration-300 reveal" style="transition-delay: {{ $i * 100 }}ms">

                            <div class="relative mb-6">
                                <div class="absolute inset-0 rounded-full bg-gold-500/20 blur-xl animate-glow"></div>
                                <img src="{{ asset('storage/' . $calon->foto) }}" alt="{{ $calon->nama }}" class="relative w-28 h-28 rounded-full object-cover
                            ...
                            <div
                                class="w-full bg-black/30 border border-gold-500/15 p-5 rounded-sm text-left text-xs space-y-3">
                                <p>
                                    <span
                                        class="font-cinzel text-[0.65rem] tracking-widest uppercase text-gold-500">Visi</span><br>
                                    <span class="text-zinc-400 mt-1 block leading-relaxed">{{ $calon->visi }}</span>
                                </p>
                                <div class="h-px bg-gold-500/10"></div>
                                <p>
                                    <span
                                        class="font-cinzel text-[0.65rem] tracking-widest uppercase text-gold-500">Misi</span><br>
    ...
    <section id="kontak" class="relative pt-20 sm:pt-24 mt-4 py-20 px-6 lg:px-10
                                 rounded-t-[3rem] sm:rounded-t-[5rem]" style="background-image: linear-gradient(to bottom, rgba(10,8,6,0.82) 0%, rgba(10,8,6,0.88) 100%), url('{{ asset('images/BACKGROUND_WEB.png') }}'); background-size: cover; background-position: center center; background-attachment: fixed;
            ...
            <div class="max-w-xl mx-auto reveal">
                ...
                <div class="card-glass rounded-lg p-8">
                    <form action="{{ route('kirim_kritik_saran') }}" method="POST" class="space-y-5">
                        ...
                        <div>
                            <label
                                class="font-cinzel text-[0.6rem] tracking-widest uppercase text-gold-500/80 mb-2 block">
                                Nama <span class="text-zinc-600 normal-case font-sans font-normal">(Opsional)</span>
                            </label>
                            <input type="text" name="nama" placeholder="Anonim" class="w-full bg-white/5 border border-gold-500/20 rounded-sm px-4 py-3
                        ...
                        <div>
                            ...
                            <textarea name="pesan" rows="5" required placeholder="Tulis masukan Anda..."
